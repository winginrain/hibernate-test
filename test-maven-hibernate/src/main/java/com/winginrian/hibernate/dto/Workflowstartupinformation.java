...
/**
 * Workflowstartupinformation generated by hbm2java
 */
public class Workflowstartupinformation implements java.io.Serializable {
	...
	public Workflowstartupinformation() {
	}

	public Workflowstartupinformation(Boolean needDate, Boolean needDescription, Boolean needName, Boolean needPerson,
			Boolean needResource, Boolean needRole, String startPage, Integer workflowId, Boolean needStartPage) {

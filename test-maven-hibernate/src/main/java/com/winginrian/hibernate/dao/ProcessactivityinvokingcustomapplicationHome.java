...
import com.winginrian.hibernate.dto.Processactivityinvokingcustomapplication;
...
public class ProcessactivityinvokingcustomapplicationHome {
	...
	public Processactivityinvokingcustomapplication merge(Processactivityinvokingcustomapplication detachedInstance) {
		...
		try {
			Processactivityinvokingcustomapplication result = (Processactivityinvokingcustomapplication) sessionFactory
	...
	public Processactivityinvokingcustomapplication findById(java.lang.Integer id) {
		...
		try {
			Processactivityinvokingcustomapplication instance = (Processactivityinvokingcustomapplication) sessionFactory
					.getCurrentSession()
	...
	public List<Processactivityinvokingcustomapplication> findByExample(
			Processactivityinvokingcustomapplication instance) {
		log.debug("finding Processactivityinvokingcustomapplication instance by example");
		try {
			List<Processactivityinvokingcustomapplication> results = (List<Processactivityinvokingcustomapplication>) sessionFactory
					.getCurrentSession()

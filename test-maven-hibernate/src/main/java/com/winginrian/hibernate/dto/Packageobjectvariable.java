...
/**
 * Packageobjectvariable generated by hbm2java
 */
public class Packageobjectvariable implements java.io.Serializable {
	...
	public Packageobjectvariable() {
	}

	public Packageobjectvariable(Integer packageId, Integer objectId, String objectName, String description,
			Short valueType, Integer fromObjectId, String xpath) {

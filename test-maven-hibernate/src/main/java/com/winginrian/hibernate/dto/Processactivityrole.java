...
/**
 * Processactivityrole generated by hbm2java
 */
public class Processactivityrole implements java.io.Serializable {
	...
	public Processactivityrole() {
	}

	public Processactivityrole(Integer processId, Integer activityId, Integer roleId, String activityUrl,
			Short minimalNumber, Short maximalNumber, Short minimalSubmittedPerson, Float workloadRatio,
			Short allocatedNumber, Integer submittedNumber, Boolean isInternalForm) {

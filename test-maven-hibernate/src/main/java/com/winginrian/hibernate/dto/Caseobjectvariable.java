...
/**
 * Caseobjectvariable generated by hbm2java
 */
public class Caseobjectvariable implements java.io.Serializable {
	...
	public Caseobjectvariable() {
	}

	public Caseobjectvariable(Integer caseId, Integer objectId, String objectName, String description, Short valueType,
			Integer fromObjectId, String xpath, String value) {
		this.caseId = caseId;

...
public class Caseinformation implements java.io.Serializable {
	...
	public Caseinformation(String caseName, String description, Integer packageId, Integer initiatorId,
			Date initiatorDate, Character durationUnit, Float costUnit) {
